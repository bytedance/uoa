...
void uoa_display_v2(union uoa_sockopt_param_v2* param)
{
    ...
    {    printf("uoa_display_v2: type error\n");
    }
}
...
void uoa_display_v1(union uoa_sockopt_param* param)
{
    ...
    {    printf("uoa_display_v1: type error\n");
    }
}
...
void* udp_echo(void* arg)
{
    ...
    while (true)
    {
                ...
                
        {
            ...
            param.input.type = UOA_IP_TYPE_V6;
            param.input.sport = ntohs(client_addr.sin6_port);
            param.input.dport = port;
            memset(&param.input.addrs, 0, sizeof(union two_addr));
            memcpy(param.input.addrs.ipv4.saddr, &client_addr.sin6_addr, sizeof(client_addr.sin6_addr));
